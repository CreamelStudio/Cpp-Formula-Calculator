...
C++로 제작한 콘솔 기반 수식 계산기입니다.
입력한 수식을 문자열로 받아 직접 파싱하고, 연산자 우선순위에 따라 계산합니다.
...
현재 버전은 직접 문자열을 파싱하는 방식으로 제작되었습니다.
따라서 일부 복잡한 수식이나 예외적인 입력에서는 정상적으로 계산되지 않을 수 있습니다.

예를 들어 다음과 같은 입력은 주의가 필요합니다.
